...
export default function HomePage() {
    return(
        <Page>
            ...
            <Typography variant='body1'>Yaffle is a simple game of football prediction. You're tested on your current knowledge of football by 
              ...
              join the game before the football season begins.</Typography>
            <Typography variant='body1'>The game is deliberately designed to be 'light touch'. Unlike Fantasy Football games, you can 
            ...
            <Typography variant='body1'>Des Oates created, and ran yaffle since (at least) 2009, but the last season ran was in 2016 (<a href="http://yaffle-2016.appspot.com/">The website is still partially running.</a>)
             His son, Matthew Oates has decided to pick it up and bring it back to life. </Typography>
            <Typography variant='h6'>How can I win Yaffle?</Typography>
            <Typography variant='body1'>Once you have chosen your 8 teams, you will appear on the Yaffle leaderboard. Your total points score on the Yaffle 
                ...
                Play-offs are not counted for in Yaffle.</Typography>
            <Typography variant='h6'>How do I join?</Typography>
            <Typography variant='body1'>Register by clicking the top right button. You will be asked to register and select your eight teams, once you've done that, you're in. In the mean 
            ...
            <Typography variant='body1'>The front end of the web app is developped using React, all of the code for it can be 
                found on my <a href="https://github.com/oates-matthew/yaffle">Github.</a> The backend is
                 ...
                 Huge appreciation for <a href="https://www.api-football.com/">API-football</a>, which is an entirely free and great resource that Yaffle relies on.</Typography>
      </Page>)
}